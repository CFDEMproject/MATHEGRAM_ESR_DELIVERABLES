...
void FixWallGran::init_heattransfer()
{
    ...
    // check if variable conductivity is defined
    fppa_vhtc = static_cast<FixPropertyAtom*>(modify->find_fix_property("variableThermalConductivity","property/atom","scalar",0,0,style,false)); 
    if(fppa_vhtc) {
