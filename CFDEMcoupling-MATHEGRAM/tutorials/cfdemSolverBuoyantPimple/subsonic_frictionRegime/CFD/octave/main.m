...
path = "../postProcessing/singleGraph/150/line_mag(U)_p_rho_T_voidfraction.xy";
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
subplot(3,2,6)
plot(simData.L_dp, [local_f; local_f(end)], 'r-', 'linewidth', 2)
xlabel('L/d_p [-]', 'interpreter', 'latex')
ylabel('f [-]', 'interpreter', 'latex')
saveas(fig, "cfdemSolverRhoPimple_frictionFlow.png")
