...
postProcFile="\"..\/postProcessing\/singleGraph\/$endTime\/line_mag(U)_p_rho_T_voidfraction_Qsource.xy\""
...
if [ $runOctave == "true" ]
    then
        ...
        #- show plot
        eog cfdemSolverRhoPimple_heatedFlow.png
...
if [ $cleanup == "true" ]; then
    ...
    rm $casePath/CFD/caseSettings/*.lig
fi
